...
string randomDistrict(int disrict){
    ...
    for(i=0;i<disrict;i++){
        districtResult = districts[rand() % districts_MAX];
...
string randomColor(int color){
    ...
    string colorResult="";
    for(i=0;i<color;i++){
        colorResult =colors[rand()% districts_MAX];
        return  colorResult;
    }
...
string randomAnimal(int animal){
    string animals[animal_MAX]={"cheetah","kangaroo","dog","cow","hen","goat","sparrow","lion","tiger"};

    string animalResult="";
    for(i=0;i<animal;i++){
        animalResult =animals[rand()%animal_MAX];
        return animalResult;
    }
    return 0;
}
    ...
    string continuePermition;
      ...
      bool checker = false;
        ...
        if(continuePermition == "y"){
            ...
            cout<<"=========================== was good to have you :)) =================================="<<endl;
